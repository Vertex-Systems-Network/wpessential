...
Key boundaries: UI/branding/navigation hiding ≠ authorization; WordPress meta-cap + Policy remain authority; Safe Script/Tag is browser-side only/no PHP/eval/server code; Backup ≠ Staging/Migration; security finding ≠ certainty; font delivery ≠ license authority; UDS state ≠ Woo cart/order truth; Theme Workspace cannot become arbitrary live PHP execution; AI/MCP cannot bypass Policy/approval.

**Current safe planning work: WP115 — Second Competitive exact executable-evidence specification, 1,936 fixtures.**
