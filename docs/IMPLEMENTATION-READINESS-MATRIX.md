...
| Free↔Pro / Product License | ADR-0070/0072/0076 paper contract; runtime/service pending | P-006 |
| CI | ADR-0011 Proposed | P-007 |
| Build toolchain | ADR-0012 Proposed | P-008 |
| Query | AST accepted; physical compiler/cache/cost/security evidence pending | P-009 |
...
| 3 | Custom Fields Builder | Exhaustive | ADR-0022 + scoped topology classes | field adapter physical/index/projection/migration/Vault evidence | No |
...
| 6 | Custom Query Builder | Exhaustive | Query AST + Multisite scope | P-009 compiler/cost/cache/IDOR/storage-adapter scale | No |
| 7 | Custom Tables Builder | Exhaustive | ADR-0023 + PT-D/PT-E classes | compiler/version/locking/backfill/recovery/migration | No |
| 8 | Admin Columns Builder | Exhaustive | typed list/source semantics | adapters/N+1/performance/write/query evidence | No |
| 9 | Dynamic Listings/Templates | Exhaustive | Blueprint + Query → SSR architecture | P-009/protected pagination/cache/site-network fixtures | No |
...
| 12 | Settings Page Builder | Exhaustive | Settings Definition + PT-A/PT-B direction | storage/autoload/inheritance/concurrency/Vault/REST | No |
...
| 15 | Membership System | Exhaustive | ADR-0078 M1/PT-D vs M2/PT-E + accepted Membership semantics | P-012 exact schema/cache/locking/files/MB certification/revoke/restore | No |
...
| 22 | REST API Builder | Exhaustive | compiled endpoint architecture | compiler/auth/rate/CORS/cache/fuzz/cross-site IDOR | No |
...
| 26 | Import / Export | Exhaustive | reviewed Plan/checkpoint/rollback architecture | run schema/source/media/scope/remap/Job evidence | No |
...
| 31 | Platform Account/Docs/Support/Diagnostics | Exhaustive | OAuth/entitlement/TUF/remote service/Product License HTTP architecture | exact OpenAPI/OAuth/TUF/idempotency/privacy/allocation/service evidence | No |
...
- **Membership M1/M2:** 0 P-012 benchmarks; **4 BE3 / 0 MB-certified**.
...
**Architecture:** accepted decisions through ADR-0085.  
**Authorized:** 0/31.  
**Implemented:** none.  
**Verified runtime:** none.  
**All newly defined physical profiles:** paper-only, 0 executable benchmark evidence.  
**Multisite:** 0 MS1+.  
