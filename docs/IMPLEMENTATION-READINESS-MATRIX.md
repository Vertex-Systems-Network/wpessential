...
| Multisite Scope/Isolation | ADR-0069/0071/0141 | MSI-01…MSI-160; MS0–MS4 certification |
| Site Lifecycle | ADR-0075/0141 | LC-01…LC-96; SL0–SL4 certification |
...
| Local Privacy | ADR-0144 | PDL-01…PDL-176; RS separate |
| Error Taxonomy | ADR-0145 | ERR-01…ERR-176 |
| Component Blueprint Core | ADR-0146 | CBP-01…CBP-176; BW/BC separate |
| Contract Versioning | ADR-0147 | VER-01…VER-176 |
...
|---:|---|---|---|---|---|
| 1 | Custom Post Types Builder | Exhaustive | WP registration + ADR-0138 | CF/DEF/KPA/UI/BT/CI/CPTX/VER/MLC/DSR/CAC/MSI/LC | No |
...
| 15 | Membership System | Exhaustive | ADR-0013…0090/0129/0173/0174 | MBR 0/160 + MB-F 0/176 + MB0–MB5 + PC-F 0/176 + PC0–PC4 + KPA/PDL/ERR/VER/MLC/CLG/DVR/CAC/RLT/RA/MSI/LC/BK | No |
...
1. CF/UI/BT/CI/JS/DEF/VT/FP/KPA/MSI/LC foundations;
2. VER/MLC/DSR/ASR/CLG/DVR/RLT/CAC + ERR/PDL/AUD;
3. CPT/Taxonomy → Fields → Relations → Query → Custom Tables;
4. Role/User Profile security;
5. Admin Menu/Dashboard Widgets/Admin Columns/Blueprint/Listings/Settings/Frontend Dashboard;
6. Membership + protected files/providers;
