...
| GOV-OWNER-CONSENT-P001-TEMP-P006-003 | TEMPORARY_MATRIX | P-001/CF → P-006 Wave 1E | **ACTIVE** | One-tranche executable environment matrix authorized exactly for P-006 Wave 1E FP-17/18 on WordPress `6.9` + PHP `8.2` + MySQL `8.4` and WordPress `7.1` + PHP `8.5` + MySQL `8.4`; disposable/sandbox exact-head inactive-Pro/dependency-state evidence only | Not reusable for FP-19+ and does not establish permanent P-001/CF product-support certification, Free/Pro pair certification, P-006 runtime certification or ADR-0010 acceptance. Live entitlement/provider/billing/payment/license/allocation calls, production credentials/data, irreversible/destructive operations and deploy/release remain separately gated. Owner wording is durably recorded in Issue #980 and governance record work is Issue #981. |
...
Wave 1E temporary P-001/CF matrix grant: **ACTIVE / `GOV-OWNER-CONSENT-P001-TEMP-P006-003`; FP-17/18 only**.
P-006 evidence truth before Wave 1E execution: **144 documented / 12 executed / 12 PASS / 0 FAIL / 0 certified Free/Pro pairs / 0 runtime certifications**.
...
The third temporary P-001/CF matrix grant is a distinct one-tranche authorization for Wave 1E FP-17/18 only on the same two disposable environment cells. It permits exact-head real-WordPress evidence for inactive installed Pro and the Free-missing dependency state, using actual WordPress dependency behavior rather than synthetic source changes. It does not establish permanent P-001/CF support, pair/runtime certification, ADR-0010 acceptance or authority for FP-19+.
