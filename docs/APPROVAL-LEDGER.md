...
| GOV-OWNER-CONSENT-P001-TEMP-P006-002 | TEMPORARY_MATRIX | P-001/CF → P-006 Wave 1D | **ACTIVE** | New one-tranche executable environment matrix for P-006 Wave 1D FP-15/16 only: WordPress `6.9` + PHP `8.2` + MySQL `8.4` and WordPress `7.1` + PHP `8.5` + MySQL `8.4`; disposable/sandbox exact-head evidence only; compatible Free+Pro activation/load-order evidence only | Does **not** authorize FP-17+, permanent P-001/CF product-support certification, Free/Pro pair certification, P-006 runtime certification, ADR-0010 acceptance, live provider/billing/license/payment/allocation calls, production credentials/data, irreversible/destructive operations, or deploy/release. Migration execution remains excluded beyond observation/admission state needed by FP-15/16. Owner wording is durably recorded in Issue #969 comment `5678050416`; governance record work is Issue #970. This authority is one-tranche and becomes non-reusable after Wave 1D closeout unless explicitly renewed/replaced. |
...
Wave 1D temporary P-001/CF matrix grant: **ACTIVE for FP-15/16 only / `GOV-OWNER-CONSENT-P001-TEMP-P006-002`**.
...
The second temporary P-001/CF matrix grant is a distinct new one-tranche authorization for Wave 1D FP-15/16 only on the same two recorded disposable environment cells. It does not reopen the Wave 1C grant, does not establish permanent P-001/CF support, and does not authorize FP-17+ or any certification promotion.
...
ADR-0014 and `DEVELOPMENT-CONSENT.md` remain controlling. Owner may revoke or narrow `GOV-OWNER-CONSENT-001`, `GOV-OWNER-CONSENT-P006-001` or `GOV-OWNER-CONSENT-P001-TEMP-P006-002` at any time, and may explicitly renew or replace any consumed temporary matrix only through a new bounded authorization.