...
function oc_string(mixed $value, string $message): string
{
...
function oc_int(mixed $value, string $message): int
{
    if (!is_int($value)) {
        throw new RuntimeException($message);
    }
...
/** @return array<mixed> */
function oc_array(mixed $value, string $message): array
{
    if (!is_array($value)) {
        throw new RuntimeException($message);
    }
...
function oc_bool(mixed $value, string $message): bool
{
    if (!is_bool($value)) {
        throw new RuntimeException($message);
    }
...
function oc_enum(mixed $value, array $allowed, string $message): string
{
