...
README audited base anchor: `main @ d2594d3be0e5c9c0b3968fd9693f2e1538211263` on **2026-09-10 UTC**. CPT Options Bank closure is promoted through Issue #467 / merged PR #469 and CPT Atomic Option Contract + UX Closure through Issue #473 / merged PR #477. Taxonomy Atomic Option Contract + UX closure is promoted through Issue #468 / merged PR #470; bounded Runtime Gap Closure evidence is promoted through merged PRs #478, #479, #480, #483, #486, #489, #503, #506 and #512 while Issue #474 remains open. Dashboard Widgets planning closure is promoted through Issue #493 / merged PR #508 and Supervisor reconciliation Issue #510 / merged PR #511 while runtime remains unpromoted. Issue #492 records the owner-directed ten-worker wave: Taxonomy remains the only runtime lane; Dashboard Widgets has completed its planning/contract gate; Surfaces 11–18 remain planning/contract-only. Repository, CI and machine-readable lifecycle files override this prose if it later becomes stale.
...
| 2 | Taxonomy Builder | ACTIVE — UX_CONTRACT_COMPLETE; Runtime Gap Closure V1 in progress; Definition + provider-ID + diagnostics + adaptive labels + reviewed 28-label authoring + tiered visibility/inheritance UX + accessible Find Setting + default-term/bounded object-term query authoring promoted / full-parity lifecycle not promoted | — / no full-parity percentage milestone | 2026-09-09T21:03:50Z | FORECAST PENDING / remaining provider/capability UX, rewrite/REST collision diagnostics, portability/compatibility, guarded migration planning and certification evidence | — | Issue #474 + merged PRs #478, #479, #480, #483, #486, #489, #503, #506, #512; #512 exact head `c06001d7...` passed Architecture #1207, Browser #295 and Package #740 before merge `d2594d3b...` | Continue provider selector/health, capability/effective-map and rewrite/REST collision diagnostics; then portability/CPT compatibility and separately gated key-migration planning |
...
| 14 | User Profile | PLANNED — ATOMIC_INVENTORY_COMPLETE; main Bank remains UNSEEDED; worker seed candidate ACTIVE / implementation baseline not promoted | — / no implementation baseline | 2026-09-10T19:47:33Z | FORECAST PENDING / native + market Bank review required | — | Issue #497; branch-local evidence matrix commit `1be3ed32...` + 8 normalized unreviewed candidate records | Verify WordPress user/profile/privacy + market evidence and ownership boundaries; no BANK_REVIEWED claim yet |
| 15 | Membership | PLANNED — ATOMIC_INVENTORY_COMPLETE; main Bank remains UNSEEDED; worker seed candidate ACTIVE / implementation baseline not promoted | — / no implementation baseline | 2026-09-10T19:47:51Z | FORECAST PENDING / native/platform + market Bank review required | — | Issue #498; branch-local evidence matrix commit `23e143ab...` + 8 normalized unreviewed candidate records | Verify membership/subscription/payment-provider evidence; payment execution remains unauthorized |
| 16 | Builder Widgets | PLANNED — ATOMIC_INVENTORY_COMPLETE; main Bank remains UNSEEDED; worker seed candidate ACTIVE / implementation baseline not promoted | — / no implementation baseline | 2026-09-10T19:48:05Z | FORECAST PENDING / WordPress + builder ecosystem Bank review required | — | Issue #499; branch-local evidence matrix commit `268f41a6...` + 8 normalized unreviewed candidate records | Verify block/builder adapters and ownership; no arbitrary executable provider/CSS input |
| 17 | Forms & Workflows | PLANNED — ATOMIC_INVENTORY_COMPLETE; main Bank remains UNSEEDED; worker seed candidate ACTIVE / implementation baseline not promoted | — / no implementation baseline | 2026-09-10T19:48:14Z | FORECAST PENDING / platform + forms/workflow market Bank review required | — | Issue #500; branch-local evidence matrix commit `deb5aba4...` + 8 normalized unreviewed candidate records | Verify form/workflow/action ownership and evidence; workflow execution remains unauthorized |
| 18 | Cron | PLANNED — ATOMIC_INVENTORY_COMPLETE; main Bank remains UNSEEDED; worker seed candidate ACTIVE / implementation baseline not promoted | — / no implementation baseline | 2026-09-10T19:48:26Z | FORECAST PENDING / WP-Cron/provider + market Bank review required | — | Issue #501; branch-local evidence matrix commit `cfd76786...` + 8 normalized unreviewed candidate records | Verify WP-Cron/Action Scheduler/provider semantics; never claim exact wall-clock execution |
...
Current machine truth after merged PR #512:
...
- PR #512 exact head `c06001d738b50faa5765c6f7f30d6085e8a19535` passed Architecture Guards #1207, Browser E2E Accessibility #295 and Distributable Package #740 before squash merge as `d2594d3be0e5c9c0b3968fd9693f2e1538211263`;
...
Remaining work includes controlled provider selector/health UX, capabilities/effective-map UX, rewrite/REST collision diagnostics, portability/CPT UI compatibility mapping, separately safety-gated taxonomy-key migration planning, and final runtime/browser/accessibility/security/compatibility/portability/performance certification evidence. This lane cannot claim `RUNTIME_CERTIFIED` or `PRODUCT_PARITY_CERTIFIED` until every accepted gap/evidence requirement closes.
...
- Worker 01: Surface 2 Taxonomy — Issue #474 / `agent/taxonomy-runtime-gap-closure-v1`; PR #512 promoted, broader program remains open.
...
- Worker 03: Surface 11 Admin Menu — Issue #494 / `agent/admin-menu-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local official-source evidence matrix commit `0695290557715b1a697b4a6a805381623798238e`; branch was non-force reconciled to pre-#512 main and must reconcile current main again before its next write/promotion.
- Worker 04: Surface 12 Settings Pages — Issue #495 / `agent/settings-pages-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local official-source evidence matrix commit `4a7e69242cce4c48498318401018f5775319dc83`; current-main reconciliation required before next write/promotion.
- Worker 05: Surface 13 Frontend Dashboard — Issue #496 / `agent/frontend-dashboard-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local evidence matrix commit `75fccc4c874fe261e5b414d9858343b05d8cf034`; current-main reconciliation required before next write/promotion.
- Worker 06: Surface 14 User Profile — Issue #497 / `agent/user-profile-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local evidence matrix commit `1be3ed3229f0f2c6e372993cdb1cc431dd642d06`; current-main reconciliation required before next write/promotion.
- Worker 07: Surface 15 Membership — Issue #498 / `agent/membership-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local evidence matrix commit `23e143ab795ef18b0eb8e0abc0e9646c99ef3752`; payment execution remains unauthorized and current-main reconciliation is required before next write/promotion.
- Worker 08: Surface 16 Builder Widgets — Issue #499 / `agent/builder-widgets-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local evidence matrix commit `268f41a66adbb0d6f8b448d2fdfb3bff9bef044d`; current-main reconciliation required before next write/promotion.
- Worker 09: Surface 17 Forms & Workflows — Issue #500 / `agent/forms-workflows-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local evidence matrix commit `deb5aba409d979efcb6a38d89b0a14462629e997`; workflow execution remains unauthorized and current-main reconciliation is required before next write/promotion.
- Worker 10: Surface 18 Cron — Issue #501 / `agent/cron-option-contract-ux-v1`; 8 normalized unreviewed candidate records plus branch-local evidence matrix commit `cfd7678698b4ccd8ac310143d3cca2eca36a4629`; WP-Cron is not represented as guaranteed wall-clock execution and current-main reconciliation is required before next write/promotion.
