...
- Active milestone: **Issue #1186 — Bounded WordPress Dashboard Adapter Contract V1**, branch `supervisor/dashboard-widgets-wordpress-dashboard-adapter-contract-v1`.
