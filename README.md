...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. P-006 bounded executable evidence is at **144 documented / 16 executed / 16 PASS / 0 FAIL / 0 certified Free/Pro pairs / 0 runtime certifications** after Waves 1A–1F. Production deployment, destructive live-provider operations, full runtime certification and product-parity certification are separate gates.
...
- P-006 executable evidence: **Waves 1A–1F complete for the bounded executed subset** through PRs #946, #951, #965, #975, #986 and #997: FP-01/02/03/05/07/08/10/11/13/14/15/16/17/18/19/20 PASS; **144 documented / 16 executed / 16 PASS / 0 FAIL / 0 certified Free/Pro pairs / 0 runtime certifications**. All four temporary P-001/CF matrix grants are consumed and non-reusable; permanent P-001/CF remains uncertified; ADR-0010 remains **Proposed**. Wave 1F used NON-RELEASE / TEST-ONLY Free `0.0.9` and `0.1.1` variants derived only by changing the plugin `Version` header plus `WPE_VERSION`; they are evidence artifacts, not releases or certification. Queue v49 exposes no Supervisor P-006 runtime/source slot; #947 remains independent Worker-only; FP-21+ requires a new accepted scope/environment authority.
...
| P-006 Waves 1A–1F | **PASS for 16 explicitly executed fixtures / NOT P-006 CERTIFIED** | 144 documented / 16 executed / 16 PASS / 0 FAIL; no certified pair/runtime; ADR-0010 Proposed; FP-21+ separately gated |
...
Surfaces 11–21 bounded read-only Runtime Foundation V1 and read-only Module/Ability exposure are complete and Pro-owned. Physical package separation is complete through Issue #904 / PR #905, local provider-neutral entitlement/edition V1 is complete through Issue #908 / PR #909, read-only Modules commercial/runtime inventory is complete through Issue #912 / PR #913, and bounded P-006 Waves 1A–1F are complete through PRs #946/#951/#965/#975/#986/#997 for 16 explicitly executed fixtures. Surfaces 22–28 remain planning/readiness-only and unseeded. Queue v49 exposes **no Supervisor-claimable P-006 runtime/source slot**; #947 remains independent-review-only and unclaimed. ADR-0010 remains Proposed, permanent P-001/CF remains uncertified, all four temporary runtime-matrix grants are consumed/non-reusable, and FP-21+ requires a new accepted exact-main gate/environment authority. Wave 1F `0.0.9`/`0.1.1` Free variants are NON-RELEASE / TEST-ONLY evidence artifacts only. Security issue #858 remains open for broader required-CI policy reconciliation while active ruleset `23374068` and the required `governance` status already protect main. Deterministic Supervisor P-006 runtime/source behavior is `NO_VALID_WORK_SLOT` until a new accepted gate exists.
...
- `docs/DECISIONS/ADR-0010-free-pro-compatibility.md` — remains Proposed; bounded P-006 evidence through PR #997 does not accept ADR-0010 or certify a Free/Pro pair
