...
- Active milestone: **Issue #1185 — #1182 terminal reconciliation + WordPress Dashboard adapter transition audit**, branch `supervisor/dashboard-widgets-wordpress-dashboard-adapter-transition-audit-v1`.
