...
- Exact current product/runtime main: `a3d7ccef7c8cba7baf5a94bafd938da3f86979d0` after **Issue #1234 / PR #1235 — Error-State source shared-truth reconciliation + FAST AI-Native policy** merged terminal PASS. **Issue #1236 / PR #1237 — Bounded Native Default-Hidden State V1** is the active FAST feature tranche.
...
- Site-targeting, Query/Data-Source, Empty-State, Renderer-Failure Error-State and #1234/#1235 shared-truth milestones are terminal PASS. **Issue #1236 / PR #1237 — Bounded Native Default-Hidden State V1** is ACTIVE under FAST AI-Native mode.
...
- Generic registered-provider execution, direct IntegrationRegistry execution, remote/iframe/RSS, asset side effects, user-preference persistence, inventory removal/discovery, collapsible/default-collapsed/dismissible, loading, caching/refresh, actions and full-parity certification remain blocked/separately gated. #1236 adds only bounded native default-hidden projection.
...
README reconciliation anchor: `current main @ a3d7ccef7c8cba7baf5a94bafd938da3f86979d0` after #1234 / PR #1235 terminal shared-truth + FAST policy merge. RB-0058 is terminal PASS; RB-0059 tracks active #1236 / PR #1237 Bounded Native Default-Hidden State V1 as the single meaningful feature merge gate. Shared truth is carried in the feature PR; no separate post-merge reconciliation is expected by default. #858 remains external-admin, #1102 authorization-gated and #947 independent Worker-only.
...
| 10 | Dashboard Widgets | UX_CONTRACT_COMPLETE; Bank BANK_REVIEWED (123); bounded runtime/ability/activation/registration/visibility/trusted-rendering chain + Runtime Render Executor V1 + Bounded WordPress Dashboard Adapter V1 + Bounded Site Targeting Source V1 + Bounded Query/Data-Source Binding Source V1 + Bounded Empty-State Rendering Source V1 + Bounded Renderer-Failure Error-State Source V1 merged; Bounded Native Default-Hidden State V1 ACTIVE / NOT full-parity RUNTIME_CERTIFIED | `████████░░ 80%` for the #1236 Default-Hidden feature tranche; implementation/tests/shared truth prepared, merge gate pending; not full product parity | 2026-09-10T19:46:54Z | FAST Turn B pending / #1236 / PR #1237 exact-head CI-review-merge | 2026-09-24T15:00:10Z for #1236 feature activation | #1234/#1235 reconciliation PASS on `a3d7ccef7c...`; #1236 implementation active | Validate #1236 feature PR terminal green; expected-head merge; resulting-main verification; no routine reconciliation PR |
