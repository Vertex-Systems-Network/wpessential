...
- Exact current main: `2669449a23ba4fc965045b8f9e419b31544bd53c` after PR #1201 merged the org-wide next-action handoff contract; latest product contract merge is **Issue #1195 / PR #1200 — Bounded Site Targeting Contract V1**, merged as `c525008c5c203863998a30d52201bee3905c0c4f`.
...
- Active milestone: **Issue #1202 — Site Targeting Source Transition Audit V1**, branch `supervisor/dashboard-widgets-site-targeting-source-transition-audit-v1`; dependency-gated next source Issue **#1203** is frozen to exactly five compiler/descriptor/adapter source/test files and remains unclaimable until #1202 audit merge.
...
- Surface 10 / Dashboard Widgets: **UX_CONTRACT_COMPLETE / bounded Runtime Foundation + Module/Ability + Pro Activation + registration/visibility/trusted-rendering chain + Runtime Render Executor V1 + Bounded WordPress Dashboard Adapter V1 + Bounded Site Targeting Contract V1 merged; Site Targeting Source Transition Audit active / NOT full-parity RUNTIME_CERTIFIED** through #1195/#1200 with active audit #1202 and dependency-gated source #1203. Canonical `target.scope` + `target.site_ids` remain fail-closed/unimplemented on exact main; source mutation is blocked until #1202 merges. Providers, remote content, assets, mutation/preferences, cache/refresh, full parity, deploy and release remain separate gates.
...
README reconciliation anchor: `main @ 2669449a23ba4fc965045b8f9e419b31544bd53c` after #1195 / PR #1200 terminal Site Targeting Contract V1 and PR #1201 AI handoff-governance merge. RC1 remains closed/non-GA. P-006 remains **144/57/57/0/0** with zero certified pairs/runtime certifications; FP-86/89/90/94 remain NOT FORMALLY EXECUTED and require separate runtime authorization. Queue v133 records #1195 terminal completion, #1202 source-transition audit active and #1203 bounded source dependency-gated. #858 remains external-admin, #1102 authorization-gated and #947 independent Worker-only.
...
| 10 | Dashboard Widgets | UX_CONTRACT_COMPLETE; Bank BANK_REVIEWED (123); bounded runtime/ability/activation/registration/visibility/trusted-rendering chain + Runtime Render Executor V1 + Bounded WordPress Dashboard Adapter V1 + Bounded Site Targeting Contract V1 merged; Site Targeting Source Transition Audit active / NOT full-parity RUNTIME_CERTIFIED | `██████████ 100%` for bounded Site Targeting Contract V1 only; not full product parity | 2026-09-10T19:46:54Z | FORECAST PENDING / #1202 transition audit active; #1203 source dependency-gated | 2026-09-23T14:27:09Z for bounded Site Targeting Contract V1 | Adapter #1188/#1190; targeting audit #1193/#1197; contract #1195/#1200; source-transition audit #1202 | Merge #1202 audit with exact-head gates; then #1203 exact five-file source tranche becomes claimable |
