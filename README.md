...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. RC1 core stabilization is closed through Issue #1016 / merged Supervisor PR #1024; P-006 bounded evidence after Wave 1L is **144 documented / 45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. FP-33 remains the sole INCONCLUSIVE/STOP-REVIEW result; FP-34/44 pass bounded real-WordPress evidence, FP-61…68/76 pass bounded pure/local Platform API range evidence, FP-45/46/53/60 pass bounded compatible update-order evidence, and FP-47/48 pass bounded complete-package breaking-order safe-degradation evidence. RC1 remains a **core production candidate / non-GA**; interrupted/manual replacement, updater/TUF, rollback/migration certification, production deployment, destructive live-provider operations, full runtime certification and product-parity certification are separate gates.
...
- P-006 executable evidence: **Waves 1A–1L have terminal results for the bounded executed subset** through PRs #946, #951, #965, #975, #986, #997, #1008, #1028, #1030, #1033, #1036 and #1039. PASS fixtures are FP-01/02/03/05/07/08/10/11/13/14/15/16/17/18/19/20/23/25/26/27/28/29/30/31/34/40/41/42/44/45/46/47/48/53/60/61/62/63/64/65/66/67/68/76. FP-33 is **INCONCLUSIVE / STOP-REVIEW**, not PASS or FAIL. Formal accounting is **144 documented / 45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Temporary grants `-001` through `-010` are consumed and non-reusable; permanent P-001/CF remains uncertified; ADR-0010 remains **Proposed**. Wave 1L initial evidence head `cfc90af3176df979d1646597414d462ab78114f8` passed workflow run `35390769301`; candidate graph artifact `10565272329` pinned F1 `f9401f81b4a65d6f610b05cd445d3d8bdec75b2996296e0deaa13a8a2a265185`, F2 `92e54db0220ea76323fcf2b0e3772ea31e379dac47ed62690b027edbccbff4dc`, P0 `0b12ada8265f3032641e09a80ba09f9950d3aef8b526b63c2b3665663aca4178`, P2 `2a56eb653a3e685a76a6c43e5f22cebfe92b0827b77475bdf2242afd094478c3`; pair IDs are F1/P0 `f5157c46d4a29af6df4929cafeaad831fc50a8d38e469c2df73340766bb3faef`, F2/P0 `72f260a4882bb04aaf05a8a4960aaaf7fa2bba0f83591aeb79f5ece4f303480c`, F1/P2 `a3bb184caaef86f4c303c2cf73ba5f7631d711cae4e280cbca035e95937f6501`. #947 remains independent Worker-only and FP-21/22/24 remain NOT EXECUTED.
...
README reconciliation base anchor before Wave 1L closeout merge: `main @ 56a6a9bcdf3d83c2f30689224c159be952f9c387` on **2026-09-18 UTC**. RC1 remains closed/non-GA. P-006 Waves 1A–1L now provide bounded evidence for **45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE**, with FP-33 still INCONCLUSIVE/STOP-REVIEW and zero certified pairs/runtime certifications. Wave 1L uses complete deterministic NON-RELEASE F1/P0/F2/P2 ZIPs on minimum/reference disposable WordPress cells: FP-47 safely degrades F2/P0 as `free_version_too_new`; FP-48 safely degrades F1/P2 as `free_version_too_old`; premium boot/migration is denied and premium modules stay inert while the Free kernel plus `custom-post-types` and `taxonomies` remain available. It does not certify partial/interrupted replacement, manual upload, updater/TUF, rollback/migrations, production deployment or release. Queue v63 records Wave 1L terminal closeout; #858 remains an external repository-admin residual and #947 remains independent Worker-only. Repository, CI and machine-readable lifecycle files override this prose if it later becomes stale.
...
| P-006 Waves 1A–1L | **44 PASS + 1 INCONCLUSIVE across 45 explicitly executed fixtures / NOT P-006 CERTIFIED** | 144 documented / 45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE; FP-33 STOP-REVIEW; no certified pair/runtime; no interruption/manual-upload/updater/rollback/migration certification; ADR-0010 Proposed; FP-21/22/24 NOT EXECUTED |
...
RC1 implementation Lanes A/B/C are integrated and remain non-GA. Bounded P-006 Waves 1A–1L now have terminal evidence through PRs #946/#951/#965/#975/#986/#997/#1008/#1028/#1030/#1033/#1036/#1039: **45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE**. Queue v63 records Wave 1L terminal closeout and exposes **no Supervisor-claimable P-006 execution slot after PR #1039 merges**; #947 remains independent-review-only. ADR-0010 remains Proposed, permanent P-001/CF remains uncertified, temporary grants `-001` through `-010` are consumed/non-reusable, FP-21/22/24 remain NOT EXECUTED, and FP-49…52 interrupted/fault-injection, FP-58 manual-upgrade replacement, rollback/stale concurrency, updater/TUF, capability/deprecation, provider, multisite and certification evidence requires separate gates. Security issue #858 remains open for broader required-CI policy reconciliation while active ruleset `23374068` and required `governance` status already protect main.
...
- `docs/DECISIONS/ADR-0010-free-pro-compatibility.md` — remains Proposed; bounded P-006 evidence through PR #1039 does not accept ADR-0010, certify a Free/Pro pair/runtime, or certify interrupted/manual-replacement, updater/TUF, rollback or migration semantics
