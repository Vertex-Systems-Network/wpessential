...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. RC1 core stabilization is closed/non-GA. P-006 bounded evidence is now **144 documented / 47 executed / 46 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications** after Wave 1N. Issue #1058 / PR #1060 gives bounded **FP-49 PASS** on the accepted direct-filesystem entrypoint-last publication profile across minimum/reference WordPress runtimes and five exact Free interruption cut points. FP-50 remains expectation-blocked; FP-51 and FP-52 remain unexecuted and require separate authorization. Generic WordPress `move_dir()`/recursive-copy interruption safety is not certified. Updater/TUF, rollback/migration certification, production deployment, destructive live-provider operations, full runtime certification and product-parity certification remain separate gates.
...
- P-006 executable evidence: **Waves 1A–1N have terminal bounded results** at **144 documented / 47 executed / 46 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Wave 1M gives FP-58 bounded PASS. Issue #1058 / PR #1060 gives **FP-49 PASS_WAVE_1N_FREE_INTERRUPTION** on minimum/reference disposable WordPress using the accepted entrypoint-last external publisher: exact cuts 1/59/119/178/238, configured Free entry absent, `free_missing`, premium boot/migrations/mutations denied, zero outbound HTTP and exact F0 recovery. FP-50 remains expectation-blocked; FP-51/52 remain unexecuted and require separate authorization. Generic WordPress recursive-copy interruption safety is not certified; permanent P-001/CF remains uncertified; ADR-0010 remains Proposed; #947 remains independent Worker-only.
...
README reconciliation base anchor before Wave 1N FP-49 closeout merge: `main @ 8f0416e017a371212b61cee0be0a04ccfa21a7c6` on **2026-09-19 UTC**. RC1 remains closed/non-GA. P-006 is **144/47/46/0/1** with zero certified pairs/runtime certifications. Queue v78 closes #1058 with FP-49 PASS and consumes TEMP-012; it exposes no Supervisor P-006 execution slot. FP-50 remains expectation-blocked; FP-51/52 remain unexecuted and require separate authorization; #858 remains external-admin and #947 independent Worker-only.
