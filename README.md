...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. RC1 core stabilization is closed through Issue #1016 / merged Supervisor PR #1024; P-006 bounded fixture evidence remains **144 documented / 45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications** after Wave 1L. Issue #1040 / PR #1042 identified the remaining B3 prerequisites; Issue #1043 / PR #1045 now validates the **WordPress-owned manual ZIP overwrite harness prerequisite** on minimum/reference Free and Pro cells using `Plugin_Upgrader::install(... overwrite_package=true)`, real plugin directories, direct filesystem, exact payload-tree identity and zero outbound HTTP. **FP-58 remains NOT_EXECUTED** and FP-49…52 remain separately gated by the readable-partial-PHP integrity/publication-contract gap. RC1 remains a **core production candidate / non-GA**; updater/TUF, rollback/migration certification, production deployment, destructive live-provider operations, full runtime certification and product-parity certification are separate gates.
...
- P-006 executable evidence: **Waves 1A–1L have terminal results for the bounded executed subset** through PRs #946, #951, #965, #975, #986, #997, #1008, #1028, #1030, #1033, #1036 and #1039. Formal accounting remains **144 documented / 45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Issue #1040 / PR #1042 is a non-runtime B3 readiness review. Issue #1043 / PR #1045 adds a **prerequisite-only** WordPress manual overwrite harness validated on WP 6.9/PHP 8.2/MySQL 8.4 and WP 7.1/PHP 8.5/MySQL 8.4 for both Free F0→F1 and Pro P0→P1. The transport is WordPress core `Plugin_Upgrader::install(local ZIP, overwrite_package=true)` with `FS_METHOD=direct`, real non-symlink plugin roots, exact before/after payload trees, preserved activation, compatible fresh boot, zero outbound HTTP and no temporary backup residue. This does **not** execute FP-58 or change fixture counters. FP-49…52 remain gated by the separate integrity/publication contract. Temporary grants `-001` through `-010` remain consumed/non-reusable; permanent P-001/CF remains uncertified; ADR-0010 remains **Proposed**; #947 remains independent Worker-only.
...
README reconciliation base anchor before manual-replacement harness closeout merge: `main @ 60ed7a9a654baa579df3a49a4cd4fce89f64fa67` on **2026-09-18 UTC**. RC1 remains closed/non-GA. P-006 Waves 1A–1L remain at **45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE**, with zero certified pairs/runtime certifications. Issue #1043 / PR #1045 validates only the WordPress-owned manual replacement transport prerequisite; harness run `35394229243` passes candidate build plus minimum/reference Free/Pro cells, while FP-58 remains NOT_EXECUTED and formal counters do not change. Queue v67 records this prerequisite closeout and exposes no Supervisor P-006 execution slot. FP-49…52 remain blocked by the integrity/publication-contract gap; #858 remains an external repository-admin residual and #947 remains independent Worker-only. Repository, CI and machine-readable lifecycle files override this prose if it later becomes stale.
...
RC1 implementation Lanes A/B/C are integrated and remain non-GA. Bounded P-006 Waves 1A–1L remain terminal at **45 executed / 44 PASS / 0 FAIL / 1 INCONCLUSIVE**. Queue v67 records the Issue #1043 / PR #1045 WordPress manual replacement **harness prerequisite** closeout and exposes **no Supervisor-claimable P-006 execution slot**. FP-58 remains NOT_EXECUTED and would require a separate explicit execution authorization; FP-49…52 remain blocked by the integrity/publication-contract gap. #947 remains independent-review-only. ADR-0010 remains Proposed, permanent P-001/CF remains uncertified, temporary grants `-001` through `-010` are consumed/non-reusable, and FP-21/22/24 remain NOT EXECUTED. Security issue #858 remains open for broader required-CI policy reconciliation while active ruleset `23374068` and required `governance` status already protect main.
