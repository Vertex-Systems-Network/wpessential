...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. RC1 core stabilization is closed/non-GA. P-006 bounded evidence is now **144 documented / 46 executed / 45 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications** after Wave 1M. Issue #1046 / PR #1048 executes FP-58 through the validated WordPress-owned `Plugin_Upgrader::install(... overwrite_package=true)` manual ZIP overwrite path across all 8 compatible/breaking minimum/reference cells; all pass. FP-49…52 remain separately blocked by the readable-partial-PHP integrity/publication-contract gap. Updater/TUF, rollback/migration certification, production deployment, destructive live-provider operations, full runtime certification and product-parity certification remain separate gates.
...
- P-006 executable evidence: **Waves 1A–1M have terminal bounded results**. Formal accounting is **144 documented / 46 executed / 45 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Wave 1M / Issue #1046 / PR #1048 adds FP-58 PASS across 8 isolated WordPress-owned manual replacement paths on WP 6.9/PHP 8.2/MySQL 8.4 and WP 7.1/PHP 8.5/MySQL 8.4. Compatible Free-first/Pro-first replacements remain compatible; breaking Free-first/Pro-first fail closed with premium boot/migrations denied and Free core modules preserved. Exact-head run `35396928791` and Governance run `35396928806` pass. `GOV-P001-CF-TEMP-011` is consumed/non-reusable. FP-49…52 remain blocked by the separate integrity/publication contract; permanent P-001/CF remains uncertified; ADR-0010 remains Proposed; #947 remains independent Worker-only.
...
README reconciliation base anchor before Wave 1M FP-58 closeout merge: `main @ a99fb1b438d35de1fca9b228d698044eceaa9fab` on **2026-09-18 UTC**. RC1 remains closed/non-GA. P-006 Waves 1A–1M stand at **46 executed / 45 PASS / 0 FAIL / 1 INCONCLUSIVE**, with zero certified pairs/runtime certifications. Final pre-merge Wave 1M head `d5e574b1154dd0db4aaaeff8b2f1983a123326f4` passed Governance `35396928806` and FP-58 workflow `35396928791`; queue v70 records TEMP-011 consumed and no Supervisor P-006 execution slot. FP-49…52 remain blocked; #858 remains external-admin and #947 independent Worker-only.
...
RC1 implementation Lanes A/B/C are integrated and remain non-GA. Bounded P-006 Waves 1A–1M are terminal at **46 executed / 45 PASS / 0 FAIL / 1 INCONCLUSIVE**. Queue v70 records Wave 1M FP-58 terminal bounded PASS and `GOV-P001-CF-TEMP-011` consumed/non-reusable, with **no Supervisor-claimable P-006 execution slot**. FP-49…52 remain blocked by the integrity/publication-contract gap. #947 remains independent-review-only. ADR-0010 remains Proposed and permanent P-001/CF remains uncertified. Security issue #858 remains open for broader required-CI policy reconciliation.
