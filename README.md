...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. RC1 core stabilization is closed through Issue #1016 / merged Supervisor PR #1024 / merge `0adcc769947bde9fe4392b506280847902792f1e`; Lanes A/B/C are integrated through Issues #1017–#1019 / PRs #1021–#1023. P-006 bounded evidence after Wave 1I is **144 documented / 30 executed / 29 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. FP-33 remains the sole INCONCLUSIVE/STOP-REVIEW result; FP-34 and FP-44 now PASS on both authorized disposable real-WordPress cells under Wave 1I, with zero outbound HTTP and no certification promotion. RC1 is a **core production candidate / non-GA**; production deployment, destructive live-provider operations, full runtime certification and product-parity certification are separate gates.
...
- P-006 executable evidence: **Waves 1A–1I have terminal results for the bounded executed subset** through PRs #946, #951, #965, #975, #986, #997, #1008, #1028 and #1030. PASS fixtures are FP-01/02/03/05/07/08/10/11/13/14/15/16/17/18/19/20/23/25/26/27/28/29/30/31/34/40/41/42/44. FP-33 is **INCONCLUSIVE / STOP-REVIEW**, not PASS or FAIL, because packaged Free and Pro artifacts contain concrete migration-owner types. Formal accounting is **144 documented / 30 executed / 29 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Temporary grants `-001` through `-007` are consumed and non-reusable; permanent P-001/CF remains uncertified; ADR-0010 remains **Proposed**. Wave 1I corrected canonical evidence head `dfac65cc18506c47d50cbb1988cd2f9f4ae86f98` passed workflow run `35351107887`; candidate artifact `10549554022` pinned Free `2acf6d202315e7105b89589822a95448febdc06634c0399dfcfc57b702e14d80`, Pro `bd74077f22c7268765519ac2d4c64dd785ba59c9eee68f5a5f1b4d8fd8de0467`, canonical pair `28e96f5207d3dc195bbf1b1a883ea7dcea5a314580661de5400e4e299dbd5211`. FP-44 minimum median/p95 were `0.002783/0.002996 ms`; reference median/p95 were `0.003144/0.003285 ms`; outbound HTTP attempts were zero. #947 remains independent Worker-only and FP-21/22/24 remain NOT EXECUTED.
...
README reconciliation base anchor: `main @ 83cb24d9070cbb4c94473c167fac639fce8210b6` on **2026-09-16 UTC**. RC1 core stabilization remains closed through Issue #1016 / merged PR #1024 after lane merge order `39b441b4c991515b3384c7f7285143855796acbc` → `891cd201667efbc72cc40285206741dc5a8c9abb` → `aaf73c702f0f8bc073e1891e0456dea5ebe23904`. P-006 evidence progressed through Wave 1A PR #946 (FP-01/02/05/07/08), Wave 1B PR #951 (FP-03/10/11), Wave 1C PR #965 (real-WordPress FP-13/14), Wave 1D PR #975 (real-WordPress compatible Free+Pro FP-15/16), Wave 1E PR #986 (real-WordPress inactive-Pro/dependency-state FP-17/18), Wave 1F PR #997 (real-WordPress marketing-version mismatch FP-19/20), Wave 1G PR #1008 (mismatch-context FP-23/25/26/27/28), and Wave 1H PR #1028 (static/harness FP-29/30/31/33/40/41/42). Wave 1H terminated with FP-29/30/31/40/41/42 PASS and FP-33 INCONCLUSIVE/STOP-REVIEW because lifecycle-owner scanning found concrete migration-owner types in the packages; static fail-closed evidence still showed incompatible decisions deny premium boot and migrations, but the lane deliberately did not change runtime behavior merely to force a PASS. The Wave 1H run executed no real WordPress runtime, provider/license calls, live credentials/sites, destructive work, deployment or release. Evidence remains partial and non-certifying: **144 documented / 28 executed / 27 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Temporary grants `-001` through `-006` are consumed/non-reusable; permanent P-001/CF remains uncertified and ADR-0010 remains **Proposed**. Queue v55 records Wave 1H terminal closeout and exposes no further Supervisor P-006 execution slot after PR #1028 merges; #947 remains independent Worker-only, FP-21/22/24 remain NOT EXECUTED, and #1015 Wave 1I FP-34/44 remains unauthorized. Canonical local entitlement states remain `free`, `trial_active`, `pro_active`, `grace`, `expired`, `suspended`, `verification_stale`, `verification_unavailable` and `incompatible_version`; verification failure is not collapsed into expiry, Membership/user authentication is not product-entitlement truth, and current premium mutation authority remains separated from read-safe module activation. Canonical machine truth remains **17 option-contract-complete-or-later / 16 UX-contract-complete / 0 full-parity runtime-certified / 0 product-parity-certified**. Options Bank truth remains **22 seeded / 22 native-audited / 22 market-audited / 22 BANK_REVIEWED / 2139 records**. Security issue #858 remains open for broader required-CI policy reconciliation; active ruleset `23374068` already enforces PR-based main protection, deletion/non-fast-forward protection, review-thread resolution, strict required `governance` status and zero bypass. Repository, CI and machine-readable lifecycle files override this prose if it later becomes stale.
...
- current formal P-006 fixture accounting is **144 documented / 30 executed / 29 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**;
- temporary grants `-001` through `-007` are consumed/non-reusable; permanent P-001/CF remains uncertified; ADR-0010 remains Proposed; FP-21/22/24 remain NOT EXECUTED; FP-34/44 are bounded Wave 1I PASS evidence and do not constitute pair/runtime certification.

These commercial and bounded evidence gates are provider-neutral local architecture/read-only observability plus partial compatibility evidence, not a live commercial license service or full P-006 certification. Wave 1H is static/harness-only and its FP-33 STOP/REVIEW result is intentionally not promoted to PASS; Wave 1I adds bounded real-WordPress FP-34/44 evidence without promoting a certified pair or runtime certification. These gates do **not** claim universal wiring of every future premium mutation path, remote verification/billing/provider integration, credential/secret persistence, ADR-0010 acceptance, a certified Free/Pro pair, P-006 runtime certification, multisite allocation semantics, deployment or release readiness.
...
| P-006 Waves 1A–1H | **27 PASS + 1 INCONCLUSIVE across 28 explicitly executed fixtures / NOT P-006 CERTIFIED** | 144 documented / 28 executed / 27 PASS / 0 FAIL / 1 INCONCLUSIVE; FP-33 STOP-REVIEW; no certified pair/runtime; ADR-0010 Proposed; FP-21/22/24 NOT EXECUTED and Wave 1I FP-34/44 separately gated |
...
RC1 implementation Lanes A/B/C are integrated through #1017/#1021, #1019/#1022 and #1018/#1023. Surfaces 11–21 bounded read-only Runtime Foundation V1 and read-only Module/Ability exposure are complete and Pro-owned. Physical package separation is complete through Issue #904 / PR #905, local provider-neutral entitlement/edition V1 is complete through Issue #908 / PR #909, read-only Modules commercial/runtime inventory is complete through Issue #912 / PR #913, and bounded P-006 Waves 1A–1H now have terminal evidence through PRs #946/#951/#965/#975/#986/#997/#1008/#1028: **28 executed / 27 PASS / 0 FAIL / 1 INCONCLUSIVE**. Queue v55 records Wave 1H closeout and exposes **no Supervisor-claimable P-006 execution slot after PR #1028 merges**; #947 remains independent-review-only. ADR-0010 remains Proposed, permanent P-001/CF remains uncertified, temporary grants `-001` through `-006` are consumed/non-reusable, FP-21/22/24 remain NOT EXECUTED, and #1015 Wave 1I FP-34/44 still requires its own accepted authorization. Security issue #858 remains open for broader required-CI policy reconciliation while active ruleset `23374068` and the required `governance` status already protect main.
...
- `docs/DECISIONS/ADR-0010-free-pro-compatibility.md` — remains Proposed; bounded P-006 evidence through PR #1028 does not accept ADR-0010 or certify a Free/Pro pair
