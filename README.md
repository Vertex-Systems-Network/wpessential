...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. RC1 core stabilization is closed through Issue #1016 / merged Supervisor PR #1024; P-006 bounded evidence after Wave 1K is **144 documented / 43 executed / 42 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. FP-33 remains the sole INCONCLUSIVE/STOP-REVIEW result; FP-34/44 pass bounded real-WordPress evidence, FP-61…68/76 pass bounded pure/local Platform API range evidence, and FP-45/46/53/60 pass bounded compatible independent update-order evidence against full NON-RELEASE overlap ZIPs. RC1 remains a **core production candidate / non-GA**; production deployment, destructive live-provider operations, updater/TUF certification, full runtime certification and product-parity certification are separate gates.
...
- P-006 executable evidence: **Waves 1A–1K have terminal results for the bounded executed subset** through PRs #946, #951, #965, #975, #986, #997, #1008, #1028, #1030, #1033 and #1036. PASS fixtures are FP-01/02/03/05/07/08/10/11/13/14/15/16/17/18/19/20/23/25/26/27/28/29/30/31/34/40/41/42/44/45/46/53/60/61/62/63/64/65/66/67/68/76. FP-33 is **INCONCLUSIVE / STOP-REVIEW**, not PASS or FAIL. Formal accounting is **144 documented / 43 executed / 42 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Temporary grants `-001` through `-009` are consumed and non-reusable; permanent P-001/CF remains uncertified; ADR-0010 remains **Proposed**. Wave 1K initial evidence head `59e8675e292d41a3a98009f8649593f57f8d22ad` passed workflow run `35388639559`; candidate graph artifact `10564059614` pinned F0 `2acf6d202315e7105b89589822a95448febdc06634c0399dfcfc57b702e14d80`, F1 `f9401f81b4a65d6f610b05cd445d3d8bdec75b2996296e0deaa13a8a2a265185`, P0 `0b12ada8265f3032641e09a80ba09f9950d3aef8b526b63c2b3665663aca4178`, P1 `96acfb8527e62f3ee52f8ef61b801f770315a3a633502ead845c5c4f145b30ac`, with pair IDs F0/P0 `c564b2fdc079a02dbba57bee0d90dd64fd683605c0fdbca89ab48323b394f2a0`, F1/P0 `f5157c46d4a29af6df4929cafeaad831fc50a8d38e469c2df73340766bb3faef`, F0/P1 `532f93f984bb5ecee1793a4c325c904e84945e35f1f5f682e20b59cbdbc58b26`. #947 remains independent Worker-only and FP-21/22/24 remain NOT EXECUTED.
...
README reconciliation base anchor before Wave 1K closeout merge: `main @ 2d307e4bdc6c5bc9da26cfd86702550f5f770fff` on **2026-09-18 UTC**. RC1 remains closed/non-GA. P-006 Waves 1A–1K now provide bounded evidence for **43 executed / 42 PASS / 0 FAIL / 1 INCONCLUSIVE**, with FP-33 still INCONCLUSIVE/STOP-REVIEW and zero certified pairs/runtime certifications. Wave 1K uses complete deterministic NON-RELEASE F0/F1/P0/P1 ZIPs on the minimum/reference disposable WordPress cells and proves compatible Free-first/Pro-first replacement, same-exact-artifact compatibility-layer retry idempotency and exact post-step health identity. It does not certify manual upload, automatic updater/TUF, interrupted replacement, rollback, migrations, production deployment or release. Queue v61 records Wave 1K terminal closeout; #858 remains an external repository-admin residual and #947 remains independent Worker-only. Repository, CI and machine-readable lifecycle files override this prose if it later becomes stale.
...
| P-006 Waves 1A–1K | **42 PASS + 1 INCONCLUSIVE across 43 explicitly executed fixtures / NOT P-006 CERTIFIED** | 144 documented / 43 executed / 42 PASS / 0 FAIL / 1 INCONCLUSIVE; FP-33 STOP-REVIEW; no certified pair/runtime; no updater/manual-upload certification; ADR-0010 Proposed; FP-21/22/24 NOT EXECUTED |
...
RC1 implementation Lanes A/B/C are integrated and remain non-GA. Bounded P-006 Waves 1A–1K now have terminal evidence through PRs #946/#951/#965/#975/#986/#997/#1008/#1028/#1030/#1033/#1036: **43 executed / 42 PASS / 0 FAIL / 1 INCONCLUSIVE**. Queue v61 records Wave 1K terminal closeout and exposes **no Supervisor-claimable P-006 execution slot after PR #1036 merges**; #947 remains independent-review-only. ADR-0010 remains Proposed, permanent P-001/CF remains uncertified, temporary grants `-001` through `-009` are consumed/non-reusable, FP-21/22/24 remain NOT EXECUTED, and breaking/interrupted replacement, rollback/stale concurrency, updater/TUF, capability/deprecation, provider, multisite and certification evidence requires separate gates. Security issue #858 remains open for broader required-CI policy reconciliation while active ruleset `23374068` and required `governance` status already protect main.
...
- `docs/DECISIONS/ADR-0010-free-pro-compatibility.md` — remains Proposed; bounded P-006 evidence through PR #1036 does not accept ADR-0010, certify a Free/Pro pair/runtime, or certify updater/manual-upload semantics
