...
> **Status:** Source development is active under explicit `GOV-OWNER-CONSENT-001` and remains milestone-gated. RC1 core stabilization is closed/non-GA. P-006 bounded evidence is now **144 documented / 48 executed / 47 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications** after Wave 1O. Issue #1061 / PR #1063 gives bounded **FP-51 PASS** over the fixed 12-cell Pro partial-file matrix on minimum/reference disposable WordPress using the accepted direct-filesystem entrypoint-last publication profile. Bootstrap-entry faults are rejected in staging before live mutation; live non-entry faults keep the configured Pro entry absent while Free remains operational, premium admission remains denied, sentinel data remains unchanged, outbound HTTP remains zero and exact P0 recovery returns compatible. FP-50 remains expectation-blocked; FP-52 remains unexecuted and requires separate authorization. Generic WordPress `move_dir()`/recursive-copy interruption safety is not certified. Updater/TUF, rollback/migration certification, production deployment, destructive live-provider operations, full runtime certification and product-parity certification remain separate gates.
...
- P-006 executable evidence: **Waves 1A–1O have terminal bounded results** at **144 documented / 48 executed / 47 PASS / 0 FAIL / 1 INCONCLUSIVE / 0 certified Free/Pro pairs / 0 runtime certifications**. Wave 1M gives FP-58 bounded PASS; Wave 1N gives FP-49 bounded PASS. Issue #1061 / PR #1063 gives **FP-51 PASS_WAVE_1O_PRO_PARTIAL_FILES** on minimum/reference disposable WordPress over 12 fixed Pro fault cells: staged bootstrap-entry faults are rejected before live mutation; ten live non-entry faults keep the Pro entry absent while Free stays operational, premium modules/boot/migrations/mutations stay denied, sentinel data is preserved, outbound HTTP stays zero and exact P0 recovery returns compatible. FP-50 remains expectation-blocked; FP-52 remains unexecuted and requires separate authorization. Generic WordPress recursive-copy interruption safety is not certified; permanent P-001/CF remains uncertified; ADR-0010 remains Proposed; #947 remains independent Worker-only.
...
README reconciliation base anchor before Wave 1O FP-51 closeout merge: `main @ 6fb08e7c4f4dbdd07db0ec22a1fb6327f224e96c` on **2026-09-19 UTC**. RC1 remains closed/non-GA. P-006 is **144/48/47/0/1** with zero certified pairs/runtime certifications. Queue v80 closes #1061 with FP-51 PASS and consumes TEMP-013; it exposes no Supervisor P-006 execution slot after merge. FP-50 remains expectation-blocked; FP-52 remains unexecuted and requires separate authorization; #858 remains external-admin and #947 independent Worker-only.
