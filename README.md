...
- Surface 10 / Dashboard Widgets: **UX_CONTRACT_COMPLETE / P0_NATIVE 12/12 bounded coverage + four P1_CORE bounded capabilities merged; type.form_action BLOCKED_BY_ACTION_PREREQUISITES; Forms/Workflow Action Ability Reference V1 ACTIVE / NOT full-parity RUNTIME_CERTIFIED**. #1262 / PR #1263 is the current FAST prerequisite tranche.
